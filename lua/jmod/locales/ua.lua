JMod.Locales["ua"] = {
	["hint wiki"] = "Дякуємо за використання JMOD-Prostir Edition! Щоб подитивсь вікі-використайте команду 'jmod_wiki'",
	["hint config"] = "Налаштуйте JMod використовуючи конфіг файл розташований в 'garrysmod/data/jmod_config.txt'",
	["hint hint reset"] = "Використайте команду jmod_resethints щоб побачити підказки знову",
	["hint qol"] = "Consider enabling some of JMod's QoL features in the config for a more realistic gmod experience",
	["hint pickup"] = "Натисніть Use щоб підібрати малий предмет",
	["hint bind cmd"] = "Пам'ятайте, ви можете 'забіндити' будь яку команду до клавіші, доприкладу: 'bind kp_ins jmod_ez_trigger'",
	["hint bind walk"] = "Впевність що у вас встановлена клавіша для ходьби, використайте команду 'bind alt +walk'",
	["hint unpackage"] = "WALK+USE щоб розпакувати",
	["hint sticky"] = "Тримайте Use, розташуйте біля стіни та відпустість щоб приліпити об'єкт",
	["hint arm"] = "Тримайте Walk та натисніть Use щоб взвести",
	["hint activate"] = "Тримайте Walk та натисність Use щоб активувати",
	["hint trigger"] = "Напишіть *trigger* в чат, або команду 'jmod_ez_trigger' для детонації",
	["hint launch"] = "Напишіть *launch* в чат, або команду 'jmod_ez_launch' для потрілу ракетою",
	["hint bombdrop"] = "Напишіть *bomb* в чат, або команду 'jmod_ez_bombdrop' щоб відварити бомбу",
	["hint mine friends"] = "Встановіть ваших друзів використовуючи команду jmod_friends; Друзі не будуть підриватись на мінах!",
	["hint prime"] = "Тримайте Walk and press Use to pick up and prime grenade",
	...
	["hint arm boundingmine"] = "Тримайте Walk and press Use when near soft terrain to burrow and arm",
	["hint arm powderkeg"] = "Тримайте Walk and press Use to toggle releasing black powder",
	["hint arm satchelcharge"] = "Тримайте Walk and press Use on the blasting machine to detonate",
	...
	["hint powder"] = "Тримайте Walk and press Use to light black powder; Тримайте Use to sweep away",
	["hint defuse"] = "Тримайте Walk and press Use multiple times to defuse",
	...
	["hint aid help"] = "Напишіть in chat 'supply radio: help' to see list of items",
	...
	["hint aid package"] = "Напишіть in chat 'supply radio: <package>' to request item",
	["hint aid wait"] = "Package will be airdropped nearby after some time",
	["hint aid menu"] = "Alternatively, Тримайте Walk and press Use on radio for shortcut menu",
	...
	["hint ent_jack_gmod_ezcrate"] = "Resource Crates can store a large amount of one resource Напишіть",
	...
	["hint sentry modify"] = "Modify with Toolbox to tweak stats and projectile Напишіть",
	...
	["hint armor wear"] = "Тримайте Walk and press Use to set color and equip armor",
	...
	["hint ent_jack_gmod_ezammo use"] = "Тримайте Walk and press Use while Тримайтеing a weapon to restore ammo",
	...
	["hint ent_jack_gmod_eznutrients use"] = "Тримайте Walk and press Use to eat",
	...
	["hint weapon steadiness"] = "Тримайте ALT while aiming to focus and steady your aim",
	["hint weapon drop"] = "Press BACKSPACE to drop weapon",
	["hint weapon firemodes"] = "Press ZOOM key to change firemodes",
	["hint weapon ammoНапишітьs"] = "Press USE and RELOAD at the same time to switch ammo Напишітьs",
	...
	["hint alt to eat"] = "press ALT+E to eat",
	...
	["hint hang on ceiling"] = "Тримайте USE to pick up, release USE to hang on the ceiling",
